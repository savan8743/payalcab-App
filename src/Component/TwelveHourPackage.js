...
const TwelveHourPackage = () => {
    ...
    useEffect(() => {
        ...
        fetch('https://bhadegadiapi.taxiwalataxi.in/api/v1/searchalldata?type=twelveHours&seats=')
                        ...
                        <div key={cab._id} className='shadow-lg bg-gray-100 rounded-lg border-2 py-8 md:py-10 flex flex-col items-center'>
                            ...
                            <div className='grid grid-cols-2'>
                                ...
                                <div className='text-[12px] md:text-[14px] font-normal'>
                                    ...
                                    <p className='mt-5'>: {cab.Type}</p>
                                    <p className='mt-5'>:  {cab.twelveHours.actualRateFix} Rs</p>
                                    <p className='mt-5'>: {cab.twelveHours.bookingKMLimit} Kms</p> 
...
export default TwelveHourPackage;
